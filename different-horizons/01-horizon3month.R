...
for (k in 1:length(arima_monthly_dates)) {
  ...
  pred_a <- forecast(auto.arima(train_tsData), 3)$mean[3]
...
#Export ----------------------------------
write_rds(forest_forecast_ts, paste0(export,"different_horizons/horizon3month/forecast.rds"))
write_rds(pred_arima, paste0(export, "different_horizons/horizon3month/arima_forecast.rds"))
